...
Namespace GradientHeightMap
    ...
    Public Class HeightMapViewModel
        ...
        Private Sub GenerateMap(ByVal uri As Uri)
            Dim imageDataLoader As ImageDataLoader = New ImageDataLoader(uri)
            ...
            Dim imageData As ImageData = New ImageData(New DoubleCollection(countX), New DoubleCollection(countZ), New DoubleCollection(countX * countZ))
            ...
            For i As Integer = 0 To countX - 1
                ...
                For j As Integer = 0 To countZ - 1
                    If Not fullZ Then imageData.YArguments.Add(startZ + j * gridStep)
